...
CREATE TABLE StudentBranches(
	...
	FOREIGN KEY (branch,programNameBranch) REFERENCES Branches(name,program),
	FOREIGN KEY (student,programNameBranch) REFERENCES Students(idnr,program),
	PRIMARY KEY (student)
);
...
WHERE (PassedCourses.course = RecommendedBranch.course AND StudentBranches.programNameBranch = RecommendedBranch.program 
